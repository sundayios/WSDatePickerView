#
#  Be sure to run `pod s lint WSDatePickerView.pods' to ensure this is a
...
Pod::s.new do |s|
  ...
  s.version      = "0.0.1"
  s.summary      = "A simple date component, can be accurate to the year, month, day time minutes and seconds of WSDatePickerView."
  ...
  s.homepage     = "http://EXAMPLE/WSDatePickerView"
