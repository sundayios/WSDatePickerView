...
-(void)defaultConfig {
    ...
    if (!self.maxLimitDate) {
        self.maxLimitDate = [NSDate date:@"2099-12-31 23:59:00" WithFormat:@"yyyy-MM-dd HH:mm:ss"];
    }
    //最小限制
    if (!self.minLimitDate) {
        self.minLimitDate = [NSDate date:@"1000-01-01 00:00:00" WithFormat:@"yyyy-MM-dd HH:mm:ss"];
    }
}
